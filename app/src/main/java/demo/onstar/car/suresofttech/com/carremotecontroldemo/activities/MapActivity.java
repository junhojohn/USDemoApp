...
//        return true;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_remote_control) {
            Intent intent = new Intent(MapActivity.this, RemoteControlSystemActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_navigation_map) {

        } else if (id == R.id.nav_vehicle_status) {
            Intent intent = new Intent(MapActivity.this, VehicleStatusActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_system_configuration) {
            Intent intent = new Intent(MapActivity.this, ConfigurationActivity.class);
            startActivity(intent);
